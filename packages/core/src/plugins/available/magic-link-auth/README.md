...
Passwordless authentication for PatroCMS via email magic links. Users sign in by clicking a secure one-time link sent to their email - no password required.
...
- ✅ **Email Integration**: Uses PatroCMS email plugin (Resend)
...
The plugin is included with PatroCMS but inactive by default.
