import { renderLogo } from '@patro-io/cms/templates'
...
<head>
  ...
  <title>${data.title} - PatroCMS Documentation</title>
      ...
      <div class="p-8">
        ...
        <div class="mt-12 pt-6 border-t border-gray-700">
          <div class="space-y-2">
            ...
            <a href="https://github.com/patro-io/cms" target="_blank" class="flex items-center px-4 py-2 text-sm text-gray-300 hover:text-purple-400 transition-colors">
          ...
          <div class="bg-gray-800/50 backdrop-blur-sm rounded-xl p-8">
            <div class="flex flex-col md:flex-row justify-between items-center text-sm text-gray-300">
              <div class="mb-4 md:mb-0">
                <p class="font-medium">© 2024 PatroCMS Documentation</p>
              ...
              <div class="flex space-x-6">
                ...
                <a href="https://github.com/patro-io/cms" target="_blank" class="hover:text-purple-400 transition-colors font-medium">GitHub</a>
              </div>
            </div>
          </div>
        </footer>
