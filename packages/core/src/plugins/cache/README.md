...
Three-tiered caching system for PatroCMS that provides automatic caching for content, users, media, and API responses.
...
Then update your `wrangler.jsonc` with the namespace IDs:
