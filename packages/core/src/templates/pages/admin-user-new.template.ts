...
export function renderUserNewPage(data: UserNewPageData, t: TranslateFn): string {
  const pageContent = `
    <div>
      <!-- Header -->
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        <div>
          <div class="flex items-center gap-3 mb-2">
            ...
            <h1 class="text-2xl/8 font-semibold text-zinc-950 dark:text-white sm:text-xl/8">${t('users.createUser')}</h1>
          </div>
          <p class="mt-2 text-sm/6 text-zinc-500 dark:text-zinc-400">${t('users.addUserDescription')}</p>
        </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
          <div class="rounded-xl bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-zinc-950/5 dark:ring-white/10 p-8">
            <form id="user-new-form" hx-post="/admin/users/new" hx-target="#form-messages">
              ...
              <!-- Basic Information -->
              <div class="mb-8">
                <h3 class="text-base font-semibold text-zinc-950 dark:text-white mb-4">${t('users.basicInformation')}</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">
                      ${t('users.firstName')} <span class="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      name="first_name"
                  ...
                  <div>
                    <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">
                      ${t('users.lastName')} <span class="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      name="last_name"
              ...
              <!-- Password -->
              <div class="mb-8">
                <h3 class="text-base font-semibold text-zinc-950 dark:text-white mb-4">${t('users.password')}</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">
              ...
              <!-- Account Status -->
              <div class="mb-8">
                <h3 class="text-base font-semibold text-zinc-950 dark:text-white mb-4">${t('users.accountStatus')}</h3>
                <div class="space-y-5">
                  <div class="flex gap-3">
                    ...
                    <div class="text-sm/6">
                      <label for="is_active" class="font-medium text-zinc-950 dark:text-white">${t('users.accountActive')}</label>
                      <p class="text-zinc-500 dark:text-zinc-400">${t('users.accountActiveDescription')}</p>
                    </div>
                  </div>
                  ...
                  <div class="flex gap-3">
                    ...
                    <div class="text-sm/6">
                      <label for="email_verified" class="font-medium text-zinc-950 dark:text-white">${t('users.emailVerified')}</label>
                      <p class="text-zinc-500 dark:text-zinc-400">${t('users.emailVerifiedDescription')}</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="lg:col-span-1">
          ...
          <div class="rounded-xl bg-blue-50 dark:bg-blue-500/10 shadow-sm ring-1 ring-blue-600/20 dark:ring-blue-500/20 p-6">
            <h3 class="text-base font-semibold text-blue-900 dark:text-blue-300 mb-2">${t('users.creatingUserTitle')}</h3>
            <div class="text-sm text-blue-700 dark:text-blue-400 space-y-3">
              <p>${t('users.creatingUserHelp1')}</p>
              <p>${t('users.creatingUserHelp2')}</p>
              <p>${t('users.creatingUserHelp3')}</p>
              <p>${t('users.creatingUserHelp4')}</p>
            </div>
          </div>

          <!-- Role Descriptions -->
          <div class="rounded-xl bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-zinc-950/5 dark:ring-white/10 p-6 mt-6">
            <h3 class="text-base font-semibold text-zinc-950 dark:text-white mb-4">${t('users.roleDescriptions')}</h3>
            <dl class="space-y-3 text-sm">
              <div>
                <dt class="font-medium text-zinc-950 dark:text-white">${t('users.roleAdmin')}</dt>
                <dd class="text-zinc-500 dark:text-zinc-400">${t('users.roleAdminDescription')}</dd>
              </div>
              <div>
                <dt class="font-medium text-zinc-950 dark:text-white">${t('users.roleEditor')}</dt>
                <dd class="text-zinc-500 dark:text-zinc-400">${t('users.roleEditorDescription')}</dd>
              </div>
              <div>
                <dt class="font-medium text-zinc-950 dark:text-white">${t('users.roleAuthor')}</dt>
                <dd class="text-zinc-500 dark:text-zinc-400">${t('users.roleAuthorDescription')}</dd>
              </div>
              <div>
                <dt class="font-medium text-zinc-950 dark:text-white">${t('users.roleViewer')}</dt>
                <dd class="text-zinc-500 dark:text-zinc-400">${t('users.roleViewerDescription')}</dd>
              </div>
            </dl>
          </div>
        </div>
