...
/**
 * Export singleton instance as PLUGIN_REGISTRY
 */
export const PLUGIN_REGISTRY = new PluginRegistryImpl()

/**
 * Core plugin IDs array - will be populated by generate-plugin-registry script
 */
