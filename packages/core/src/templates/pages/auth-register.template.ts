...
export function renderRegisterPage(data: RegisterPageData, t: TranslateFn): string {
  return `
    <!DOCTYPE html>
    ...
    <head>
      ...
      <title>${t('auth.register')} - PatroCMS</title>
    ...
    <body class="h-full bg-zinc-950">
      <div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-md text-center">
          ...
          <p class="mt-2 text-sm text-zinc-400">${t('auth.getStarted')}</p>
        </div>
          ...
          <div class="bg-zinc-900 shadow-sm ring-1 ring-white/10 rounded-xl px-6 py-8 sm:px-10">
            ...
            <div class="mt-6 text-center">
              <p class="text-sm text-zinc-400">
                ...
                <a href="/auth/login" class="font-semibold text-white hover:text-zinc-300 transition-colors">${t('auth.signInHere')}</a>
              </p>
            </div>
