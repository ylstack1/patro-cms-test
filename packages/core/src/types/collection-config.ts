...
export interface CollectionConfig {
   ...
   * @deprecated Use codeManaged and fieldsEditable instead
   */
  managed?: boolean

  /**
   * If true, this collection is defined in code (config files)
   * This means the collection structure (name, schema) is controlled by code
   * Default: true for config-based collections
   */
  codeManaged?: boolean

  /**
   * If true, fields in this collection can be edited in the UI even if the collection is code-managed
   * Default: true
   */
